...
$("#local-sky").append("<img src = \"" + conditions.weather[0].icon + "\"> </br>" + conditions.weather[0].description);
...
$("#astronomy").append("Sunrise: " + sunrise);
$("#astronomy").append("</br>Sunset: " + sunset);
}); //end load weather
});
}
